...
#### Сетевой обмен [](#){name=сетевой-обмен}
...
### Разворачиваем сервер Wazuh [](#){name=разворачиваем-сервер-Wazuh}
...
### Подключаем агента [](#){name=подключаем-агента}
...
### Проверяем агента [](#){name=проверяем-агента}
...
### Проверка целостности файлов [](#){name=проверка-целостности-файлов}
...
### Выявление уязвимостей в соотстветвии с документацияей [](#){name=выявление-уязвимостей-в-соотстветвии-с-документацияей}
...
### Выявление скрытых процессов [](#){name=выявление-скрытых-процессов}
...
### Наcтрока выявления SQL-инъекций [](#){name=наcтрока-выявления-SQL-инъекций}
...
### Выявление web shell attack [](#){name=выявление-web-shell-attack}
